...
------------------- | ------------------ | ------------ | ----------- | -----
Literal[""] _(default)_  | False _(default)_ | **`GetBatchOperationResponse`** |  | [GetBatchOperationResponse](GetBatchOperationResponse.md)
...
from waylay.services.alarms.models.batch_operation_enqueued import (
    BatchOperationEnqueued,
)
