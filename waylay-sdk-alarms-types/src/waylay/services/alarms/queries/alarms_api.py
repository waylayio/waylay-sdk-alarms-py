...
from ..models.additional_query_param_value import AdditionalQueryParamValue
...
class ListQuery(WaylayBaseModel):
    ...
    type: Annotated[
        list[StrictStr] | None,
        Field(description="Filter on one or more alarm types."),
    ] = None
    status: Annotated[
    ...
    additional_query_params: Annotated[
        dict[str, AdditionalQueryParamValue] | None,
        Field(
