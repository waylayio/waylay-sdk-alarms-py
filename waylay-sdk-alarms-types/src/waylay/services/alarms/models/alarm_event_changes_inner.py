...
class AlarmEventChangesInner(BaseModel):
    """AlarmEventChangesInner."""

    attribute: StrictStr | None = None
    type: StrictStr | None = Field(
        default=None, description="Indication of what has changed"
    )
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in (
            ...
            raise ValueError(
                "must be one of enum values ('io.waylay.alarm.change.severity', 'io.waylay.alarm.change.status', 'io.waylay.alarm.change.attribute')"
            )
        return value
    ...
    def to_dict(self) -> dict[str, Any]:
        """Convert the AlarmEventChangesInner instance to dict."""
        return self.model_dump(by_alias=True, exclude_unset=True, exclude_none=True)

    def to_json(self) -> str:
        """Convert the AlarmEventChangesInner instance to a JSON-encoded string."""
    ...
    def from_dict(cls, obj: dict) -> Self:
        """Create a AlarmEventChangesInner instance from a dict."""
        return cls.model_validate(obj)

    @classmethod
    def from_json(cls, json_data: str | bytes | bytearray) -> Self:
        """Create a AlarmEventChangesInner instance from a JSON-encoded string."""
