...
class CloudAlarmEventData(BaseModel):
    """CloudAlarmEventData."""
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in (
            ...
            raise ValueError(
                "must be one of enum values ('io.waylay.alarms.v1.AlarmRaised', 'io.waylay.alarms.v1.EventOccurredAgain', 'io.waylay.alarms.v1.AlarmUpdated')"
            )
        return value
    ...
    def to_dict(self) -> dict[str, Any]:
        """Convert the CloudAlarmEventData instance to dict."""
        return self.model_dump(by_alias=True, exclude_unset=True, exclude_none=True)

    def to_json(self) -> str:
        """Convert the CloudAlarmEventData instance to a JSON-encoded string."""
    ...
    def from_dict(cls, obj: dict) -> Self:
        """Create a CloudAlarmEventData instance from a dict."""
        return cls.model_validate(obj)

    @classmethod
    def from_json(cls, json_data: str | bytes | bytearray) -> Self:
        """Create a CloudAlarmEventData instance from a JSON-encoded string."""
