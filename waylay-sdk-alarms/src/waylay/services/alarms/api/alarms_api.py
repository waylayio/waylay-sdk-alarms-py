...
class AlarmsApi(WithApiClient):
    ...
    async def create(
        ...
        **kwargs,
        ...
        if json is not None and validate_request:
            _BodyType = Annotated[CreateAlarm, Field(description="Alarm Operations")]  # fmt: skip  # noqa: UP045
    ...
    async def list(
        ...
        **kwargs,
        ...
        :type query['additionalQueryParams']: Dict[str, AdditionalQueryParamValue]
        :param raw_response: If true, return the http Response object instead of returning an api model object, or throwing an ApiError.
        :param select_path: Denotes the json path applied to the response object before returning it.
                Set it to the empty string `""` to receive the full response object.
        :param response_type: If specified, the response is parsed into an instance of the specified type.
    ...
    async def update(
        ...
        **kwargs,
        ...
        body_args: dict[str, Any] = {}
        if json is not None and validate_request:
            _BodyType = AlarmUpdate  # fmt: skip  # noqa: UP045
            body_adapter: TypeAdapter = TypeAdapter(_BodyType)
            json = body_adapter.validate_python(json)  # type: ignore # https://github.com/pydantic/pydantic/discussions/7094
        body_args["json"] = json
