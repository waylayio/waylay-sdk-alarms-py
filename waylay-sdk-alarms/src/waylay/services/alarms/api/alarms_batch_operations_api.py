...
try:
    ...
    if not TYPE_CHECKING:
        GetQuery = dict
        GetBatchOperationResponse = Model
...
class AlarmsBatchOperationsApi(WithApiClient):
    ...
    async def get(
        ...
        *,
        ...
        headers: HeaderTypes | None = None,
        **kwargs,
    ) -> GetBatchOperationResponse | T | Response | Model:
        ...
        response_types_map: dict[str, Any] = (
            ...
            if response_type is not None
                ...
                "200": GetBatchOperationResponse if not select_path else Model,
            }
        )
    ...
    async def start(
        ...
        **kwargs,
        ...
        if json is not None and validate_request:
            _BodyType = Annotated[BatchAlarmsSpecification, Field(description="Batch Alarm Operation")]  # fmt: skip  # noqa: UP045
