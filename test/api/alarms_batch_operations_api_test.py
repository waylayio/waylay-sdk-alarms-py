...
from ..types.get_batch_operation_response_stub import GetBatchOperationResponseStub
...
def _get_set_mock_response(httpx_mock: HTTPXMock, gateway_url: str, batchId: str):
    mock_response = GetBatchOperationResponseStub.create_json()
    httpx_mock_kwargs = {
        "method": "GET",
...
async def test_get(service: AlarmsService, gateway_url: str, httpx_mock: HTTPXMock):
    ...
    check_type(resp, GetBatchOperationResponse)
