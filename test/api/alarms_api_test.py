...
from ..types.additional_query_param_value_stub import AdditionalQueryParamValueStub
...
from ..types.list_order_stub import ListOrderStub

MODELS_AVAILABLE = (
    find_spec("waylay.services.alarms.models") is not None
)
...
async def test_list(service: AlarmsService, gateway_url: str, httpx_mock: HTTPXMock):
    ...
    kwargs = {
        ...
        "query": ListQuery(
            ...
            sort="timestamp",
            order=ListOrderStub.create_json(),
            page=1,
            size=50,
            additional_query_params={
                "inner": AdditionalQueryParamValueStub.create_json()
            },
        ),
    }
