...
class AlarmUpdateStub:
    ...
    def create_json(cls):
        ...
        return alarm_update_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "AlarmUpdate":
        ...
        if json is None:
            ...
            backup_faker = JSF(AlarmUpdateAdapter.json_schema(), allow_none_optionals=1)
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return AlarmUpdateAdapter.validate_python(
