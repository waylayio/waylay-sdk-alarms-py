...
class AlarmEventStub:
    ...
    def create_json(cls):
        ...
        return alarm_event_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "AlarmEvent":
        ...
        if json is None:
            ...
            backup_faker = JSF(AlarmEventAdapter.json_schema(), allow_none_optionals=1)
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return AlarmEventAdapter.validate_python(
